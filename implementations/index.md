...
* [jsonapi](https://github.com/jeregrine/jsonapi) is a serializer and query parser capable built around plain old functions. Can parse and validate a JSONAPI compliant query and serialize Ecto Models or Elixir Structs into conforming JSON. Suitable for use in a Phoenix view or in a Plug stack.
